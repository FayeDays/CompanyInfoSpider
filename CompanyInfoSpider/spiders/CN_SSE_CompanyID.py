...
class CNSSEcompanyidSpider(scrapy.Spider):
    name = 'CNSSECompanyID'
    custom_settings = { 'ITEM_PIPELINES':{'CompanyInfoSpider.pipelines2mysqlfast.CncompanyidSpiderFastPipeline': 1}}
    allowed_domains = ['dl.app.gtja.com']
    start_urls = ['http://dl.app.gtja.com/public/fyevent/stockfile/sz_stkinfo.txt',
                  'http://dl.app.gtja.com/public/fyevent/stockfile/sh_stkinfo.txt']
