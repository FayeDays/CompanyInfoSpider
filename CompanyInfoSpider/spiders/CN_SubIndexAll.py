...
class CNSubAllIndexSpider(scrapy.Spider):
    name = 'CNSubAllInd'
    ...
    custom_settings = {'ITEM_PIPELINES': {'CompanyInfoSpider.pipelinesTest.CNTestPipeline': 1}}
    varint = 0
    compIDList = []
    RepIDList = []
    RepNameList = []
    ...
    def getCompID(self):
        ...
        self.cursor.execute("select id,name from cn_id limit 20")
        self.conn.commit()
