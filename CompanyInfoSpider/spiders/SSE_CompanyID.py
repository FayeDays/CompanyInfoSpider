...
class CNSSEcompanyidSpider(scrapy.Spider):
    name = 'SSECompanyID'
    custom_settings = { 'ITEM_PIPELINES':{'CompanyInfoSpider.pipelinesSSEid.CncompanyidSpiderFastPipeline': 1}}
    allowed_domains = ['dl.app.gtja.com']
    start_urls = ['http://dl.app.gtja.com/public/fyevent/stockfile/sh_stkinfo.txt']
